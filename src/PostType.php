 ...
 *
 * @method PostType label(string $label)
 * @method PostType labels(array $labels)
 * @method PostType description(string $description)
 * @method PostType public(bool $public)
 * @method PostType exclude_from_search(bool $exclude_from_search)
 * @method PostType publicly_queryable(bool $publicly_queryable)
 * @method PostType show_ui(bool $show_ui)
 * @method PostType show_in_nav_menus(bool $show_in_nav_menus)
 * @method PostType show_in_menu(bool|string $show_in_menu)
 * @method PostType show_in_admin_bar(bool $show_in_admin_bar)
 * @method PostType menu_position(int $public)
 * @method PostType menu_icon(string $menu_icon)
 * @method PostType capability_type(string | array $capability_type)
 * @method PostType capabilities(array $capabilities)
 * @method PostType map_meta_cap(bool $map_meta_cap)
 * @method PostType hierarchical(bool $hierarchical)
 * @method PostType supports(bool | array $supports)
 * @method PostType register_meta_box_cb(callable $register_meta_box_cb)
 * @method PostType taxonomies(array $taxonomies)
 * @method PostType has_archive(bool|string $has_archive)
 * @method PostType rewrite(bool | array $rewrite)
 * @method PostType permalink_epmask(bool $permalink_epmask)
 * @method PostType query_var(bool | string $query_var)
 * @method PostType can_export(bool $can_export)
 * @method PostType delete_with_user(bool $delete_with_user)
 * @method PostType show_in_rest(bool $show_in_rest)
 * @method PostType rest_base(string $rest_base)
 * @method PostType rest_controller_class(\WP_REST_Controller $rest_controller_class)
 */
